...
**文档过滤示例**：8. $contains 全文搜索 9. $regex 正则匹配

**组合过滤示例**：10. 元数据 + 文档过滤器组合 11. 向量查询 + 元数据过滤 12. 删除操作 + 元数据过滤
...
await collection.get({
  where: {
    $and: [{ category: "programming" }, { difficulty: "advanced" }],
  },
});
