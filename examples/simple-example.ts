...
async function main() {
  ...
  console.log(`Created collection '${collection.name}' with dimension: ${collection.dimension}`);
  ...
  console.log('Note: Embeddings were automatically generated from documents using the embedding function');
